...
- Each release is published as the Docker image `muneer2ishtech/ishtech-springboot-multi-port` on Docker Hub, tagged with the version, for example `x.y.z` or `x.y.z-jdk21`.
